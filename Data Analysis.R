...
#read data
credit<-read.csv('C:/Users/Admin/Desktop/申请/BA/Risk Analysis/credit_risk_dataset2.csv')
...
#confusion matrix
table(test$default,pre_kknn,dnn=c("真实值","预测值"))
#roc
...
#confusion matrix
table(test$default,pre_svm,dnn=c("真实值","预测值"))
#roc
...
per[1,1]<-sensitivity(table(test$default,pre_kknn,dnn=c("真实值","预测值")))
...
per[1,2]<-specificity(table(test$default,pre_kknn,dnn=c("真实值","预测值")))
...
per[1,3]<-accuracy(table(test$default,pre_kknn,dnn=c("真实值","预测值")))
...
#confusion matrix
table(test2$default,pre_kknn2,dnn=c("真实值","预测值"))
#roc
...
#confusion matrix
table(test2$default,pre_svm2,dnn=c("真实值","预测值"))
...
per2[1,1]<-sensitivity(table(test2$default,pre_kknn2,dnn=c("真实值","预测值")))
...
per2[1,2]<-specificity(table(test2$default,pre_kknn2,dnn=c("真实值","预测值")))
...
per2[1,3]<-accuracy(table(test2$default,pre_kknn2,dnn=c("真实值","预测值")))
